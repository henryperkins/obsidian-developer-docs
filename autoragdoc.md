...
To learn more details about how AutoRAG uses RAG under the hood, reference [How AutoRAG works](https://developers.cloudflare.com/autorag/concepts/how-autorag-works/).
...
9. Select Create to spin up your AutoRAG.
